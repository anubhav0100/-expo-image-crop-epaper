    ...
    render() {
        ...
        return (
            ...
            >
                <SafeAreaView
                    style={{
                        width, flexDirection: 'row', backgroundColor: this.props.colorbg, justifyContent: 'space-between',
                    }}
                >
                    <ScrollView scrollEnabled={false}
                        horizontal
                        contentContainerStyle={{
                            width: '100%', paddingHorizontal: 15, height: 50, alignItems: 'center',
                        }}
                    >
                        {!cropMode
                            ? (
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    >
                                        <Icon size={30} name="arrow-left" color="white" />
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={() => this.onToggleModal()}
                                        style={{
...

                                        {
                                            ...
                                            && (
                                                <View style={{ flexDirection: 'row' }}>
                                                    ...
                                                    >
                                                        <MaterialIcon style={{ transform: [{ rotate: '270deg' }] }} size={30} name="flip" color="white" />
                                                    </TouchableOpacity>
                                                </View>
                                            )
                                        }
                                        {
                                            ...
                                            && (
                                                <View style={{ flexDirection: 'row' }}>
                                                    ...
                                                    >
                                                        <MaterialIcon size={30} name="flip" color="white" />
                                                    </TouchableOpacity>
                                                    ...
                                                    >
                                                        <Text style={{ fontWeight: '500', color: 'white', fontSize: 25 }}>{btnTexts.done}</Text>
                                                    </TouchableOpacity>
                                                </View>
                                            )
                                        }
